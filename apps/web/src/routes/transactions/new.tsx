...
const formSchema = z
  ...
  .refine((data) => !!data.contactId, {
    message: "A contact is required for this transaction type",
    path: ["contactId"],
  });
                    ...
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} value={field.value}>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value={TransactionType.LoanReceived}>
                            Loan Received
                          </SelectItem>
                          ...
                          <SelectItem value={TransactionType.GiftReceived}>
                            Gift Received
                          </SelectItem>
