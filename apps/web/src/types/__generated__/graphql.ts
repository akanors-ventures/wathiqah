...
export type UpdatePromiseMutation = {
  updatePromise: {
    __typename: "Promise";
    id: string;
    description: string;
...
export type MyAccessGrantsQuery = {
...
export type GrantAccessMutation = {
  grantAccess: { __typename: "AccessGrant"; id: string; email: string; status: AccessStatus };
};
...
export type RevokeAccessMutation = {
  revokeAccess: { __typename: "AccessGrant"; id: string; status: AccessStatus };
};

export type ReceivedAccessGrantsQueryVariables = Exact<{ [key: string]: never }>;

export type ReceivedAccessGrantsQuery = {
  receivedAccessGrants: Array<{
    __typename: "AccessGrant";
    id: string;
    email: string;
    token: string;
...
export type AcceptAccessMutation = {
  acceptAccess: { __typename: "AccessGrant"; id: string; status: AccessStatus };
};
...
export type SharedDataQuery = {
  sharedData: {
    ...
    transactions: Array<{
      ...
      contact: { __typename: "Contact"; name: string } | null;
      witnesses: Array<{
        __typename: "Witness";
        id: string;
        status: WitnessStatus;
